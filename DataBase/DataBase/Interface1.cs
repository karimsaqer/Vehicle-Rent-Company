    ...
    public partial class Interface : Form
    {
        ...
        private void nowchange_Click(object sender, EventArgs e)
        {
            if (User.Text == "Employee")
            {
                ...
                {
                    controllerObj.changepasswordEMP(textBox2.Text, Phone_No.Text);
                }
            }
            else if(User.Text == "Lessor")
            {
                ...
                {
                    controllerObj.changepasswordLessor(textBox2.Text, Phone_No.Text);
                }
            ...
            else if(User.Text == "Renter")
            {
                ...
                {
                    controllerObj.changepasswordRenter(textBox2.Text, Phone_No.Text);
                }
            }
            else
            {
