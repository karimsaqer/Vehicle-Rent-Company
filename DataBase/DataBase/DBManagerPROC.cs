...
namespace DataBase
{
    public class DBManagerPROC
    {
        static string DB_Connection_String = @"Data Source=DESKTOP-LVR1R05;Initial Catalog=VehicleSystem;Integrated Security=True";
        SqlConnection myConnection;

        public DBManagerPROC()
        {
